...
import happy from "../Assets/Icon/happy.webp";
              ...
              <div className="row">
                {/* <div className="col-lg-3">
                  <div class="countflex">
                    ...
                    <h6 class="counttext my-auto">
                      <span class="CountUp">
                        <CountUp end={1280} duration={3} delay={5} />
                      </span>
                      <span class="CountUp"> + </span>Happy Customer
                    </h6>
                  </div>
                </div> */}
                {/* <div className="col-lg-3">
                  <div class="countflex">
                    ...
                    <h6 class="counttext1 my-auto">
                      <span class="CountUp">
                        <CountUp end={12} duration={3} delay={5} />
                      </span>
                      <span class="CountUp"> + </span>Agent
                    </h6>
                  </div>
                </div>
                <div className="col-lg-3">
                  <div class="countflex">
                    <div class="countbox2"></div>
                    <h6 class="counttext2 my-auto">
                      <span class="CountUp">
                        <CountUp end={120} duration={3} delay={5} />
                      </span>
                      <span class="CountUp"> + </span>Products
                    </h6>
                  </div>
                </div>
                <div className="col-lg-3">
                  <div class="countflex">
                    <div class="countbox3"></div>
                    <h6 class="counttext3 my-auto">
                      <span class="CountUp">
                        <CountUp end={3} duration={3} delay={5} />
                      </span>
                      <span class="CountUp"> + </span>Factories
                    </h6>
                  </div>
                </div> */}
              </div>
